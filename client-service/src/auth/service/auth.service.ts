...
import { AdminService } from "../../admin-micro-service/admin-service.service";
...
export class AuthService {
    ...
    constructor(
        ...
        // private userLogMicroService: UserLogMicroService
    ...
    async signIn(signInCredentialsDto: SignInCredentialsDto): Promise<{ accessToken: string, refreshToken: string, user: JwtPayload }> {
        ...
        try {
            this.adminService.createUserLog({ userEmail: signInCredentialsDto.username });
        } catch (error) {
